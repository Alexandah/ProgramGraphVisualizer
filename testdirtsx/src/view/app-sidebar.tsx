...
import BarItemModel, { BarItemGroup as BarItemGroup, BarItemId } from "src/model/filter";
...
export function Employers(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Employer, name: "Employers", group: BarItemGroup.Other });
...
export function Members(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Member, name: "Members", group: BarItemGroup.Other });
            props.selectView(model)
...
export function SelectPlusContribution(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Contribution, name: "Contributions (Select+)", group: BarItemGroup.SelectPlus });
            props.selectView(model)
...
export function SelectPlusTransactions(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Transaction, name: "Transactions (Select+)", group: BarItemGroup.SelectPlus });
            props.selectView(model)
...
export function SelectPlusInvoice(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Invoice, name: "Invoices (Select+)", group: BarItemGroup.SelectPlus });
            props.selectView(model)
...
export function SelectPlusPayment(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Payment, name: "Payments (Select+)", group: BarItemGroup.SelectPlus });
            props.selectView(model)
...
export function AccessPlusContribution(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Contribution, name: "Contributions (Access+)", group: BarItemGroup.AccessPlus });
            props.selectView(model)
...
export function AccessPlusTransactions(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Transaction, name: "Transactions (Access+)", group: BarItemGroup.AccessPlus });
            props.selectView(model)
...
export function AccessPlusInvoice(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Invoice, name: "Invoices (Access+)", group: BarItemGroup.AccessPlus });
            props.selectView(model)
...
export function AccessPlusPayment(props: AppModel) {
    ...
    return <div className="cl-panel-item-level1 list-group-item list-group-item-action flex-column align-items-start"
        onClick={() => {
            let model = new BarItemModel({ id: BarItemId.Payment, name: "Payments (Access+)", group: BarItemGroup.AccessPlus });
            props.selectView(model)
...
export default function EditorSidebar(props: AppModel) {
    return <div id="sidebar-container" className="col-md-3 col-xl-2 sidebar-container d-none d-md-block">
