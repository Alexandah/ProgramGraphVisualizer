...
export default function SelectPlusTransactionsView(props: AppModel) {
    ...
    const RESOURCE_NAME = "selectPlus/transactions";
    ...
    React.useEffect(() => {
        ...
        if (data)
            for (let fm of data)
                r.push({
                    'id': fm.id, 'cell': [fm.memberName, fm.employerName,
