...
export default function SelectPlusContributionsView(props: AppModel) {
    ...
    const RESOURCE_NAME = 'selectPlus/contributions';
    ...
    React.useEffect(() => {
        ...
        if (data)
            for (let fm of data)
                r.push({
                    'id': fm.id, 'cell': [fm.memberName, fm.employerName, fm.startBillingPeriod, fm.endBillingPeriod,
                    ...
                    fm.totalContribution, fm.id, fm.memberId, fm.employerId]
                })
    ...
    return <div>
        ...
        {data &&
            <CSVLink data={data}
                ...
                filename="contributions_select_plus.csv">
                CSV Export
        </CSVLink>
        }
    </div >
